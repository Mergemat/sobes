...
Вёрстка и CSS были реализованы с использованием LLM, чтобы сократить время на визуальную часть. Основной фокус работы — архитектурные решения, границы модулей и организация потока данных.
...
- `nuqs` хранит фильтры в URL, поэтому ссылку можно сохранить или отправить другому человеку, а отдельный store не нужен ([docs](https://nuqs.dev/docs/basic-usage)).
